        ...
        /* private bool ValidarColumnas(string tabla, string[] columnasEnviadas, out List<string> columnasBD)
          {
              ...
              if (columnasFaltantes.Count > 0)
              {
                  MessageBox.Show("Las siguientes columnas no existen: " + string.Join(", ", columnasFaltantes));
                  return false;
              }
       ...
       //======================= Pedro Ibañez ======================
        ...
        public DataGridView CrearDataGridView()
        {
           //int PosYdgv = startY + 20; 
            ...
            dgv.Location = new System.Drawing.Point(10, 350);
